        ...
        <div className="min-h-screen flex gradient-animated">
                ...
                <div className="relative z-10 max-w-md text-center stagger-children">
                    ...
                    <div className="space-y-4 text-left">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3 text-slate-300 text-lg">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 overflow-y-auto bg-white">
                <div className="w-full max-w-md animate-fade-in-up">
                    ...
                    <div className="flex items-center justify-center gap-4 mb-8">
                        {[1, 2].map((s) => (
                            <div key={s} className="flex items-center">
                                ...
                                {s < 2 && (
                                    <div className={`w-16 h-1 mx-2 rounded-full transition-all ${step > 1 ? 'bg-orange-500' : 'bg-slate-100'
                                        }`}></div>
                                )}
                            </div>
                        ))}
                    ...
                    {/* Error Message */}
                    {(formError || authError) && (
                        <div className="mb-6 p-4 bg-red-50 border border-red-100 rounded-xl text-red-600 text-sm flex items-center gap-3 animate-shake">
                        ...
                        {step === 1 ? (
                            <>
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all outline-none text-slate-900 font-medium placeholder:text-slate-400"
                                ...
                                <div className="p-4 bg-orange-50 border border-orange-100 rounded-xl flex gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-slate-900 text-sm">Devotee Account</h3>
                                        <p className="text-xs text-slate-600 mt-1">
                                            For staff access, please contact your administrator.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <button
                                    type="button"
                                    onClick={handleNext}
                                    className="w-full btn-primary py-4 text-lg font-bold flex items-center justify-center gap-3 shadow-xl hover:shadow-orange-500/30 transition-all"
                                >
                                    Continue
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <>
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-12 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all outline-none text-slate-900 font-medium placeholder:text-slate-400"
                                    ...
                                    <div className="mt-3 space-y-2">
                                        {[
                                            ...
                                            <div key={i} className="flex items-center gap-2 text-xs font-medium">
                                                <div className={`w-4 h-4 rounded-full flex items-center justify-center transition-colors ${req.check ? 'bg-green-500' : 'bg-slate-200'
                                                    }`}>
                                                    {req.check && (
                                                ...
                                                <span className={req.check ? 'text-green-700' : 'text-slate-400'}>
                                                    {req.text}
                                                </span>
                                            </div>
                                        ))}
                                ...
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-12 pr-12 py-3.5 bg-slate-50 border rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all outline-none text-slate-900 font-medium placeholder:text-slate-400 ${formData.confirmPassword && !passwordsMatch
                                ...
                                <label className="flex items-start gap-3 cursor-pointer group p-3 rounded-lg hover:bg-slate-50 transition-colors">
                                    ...
                                    <span className="text-sm text-slate-600 group-hover:text-slate-900 transition-colors">
                                        I agree to the{' '}
                                        <Link href="/terms" className="text-orange-600 hover:text-orange-700 font-bold underline decoration-orange-200 underline-offset-2">
                                            Terms of Service
                                        </Link>{' '}
                                        and{' '}
                                        <Link href="/privacy" className="text-orange-600 hover:text-orange-700 font-bold underline decoration-orange-200 underline-offset-2">
                                            Privacy Policy
                                        </Link>
                                    </span>
                                </label>
                                ...
                                <div className="flex gap-4">
                                    <button
                                        type="button"
                                        onClick={() => setStep(1)}
                                        className="flex-1 btn-secondary py-4 text-lg font-bold flex items-center justify-center gap-2 hover:bg-slate-200"
                                    >
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 btn-primary py-4 text-lg font-bold flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed shadow-xl hover:shadow-orange-500/30 transition-all"
                                    >
                                        {isSubmitting ? (
                                            <>
                ...
                {/* Security Badge */}
                <div className="mt-8 flex items-center justify-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-400">
